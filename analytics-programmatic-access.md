---
title: Programmatic access paradigm - commercial marketplace
...
:::image type="content" source="./media/analytics-programmatic-access/analytics-high-level-flow.png" alt-text="Illustrates the API call pattern used to create a new report template, schedule the custom report, and retrieve failure data." lightbox="./media/analytics-programmatic-access/analytics-high-level-flow.png":::
