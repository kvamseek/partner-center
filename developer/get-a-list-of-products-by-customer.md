...
Follow this example to get a list of products by country/region for new commerce license-based services as part of the new commerce experience technical preview. New commerce license-based services will be identifed by id and displayNames values of **OnlineServicesNCE**. See response example below.
