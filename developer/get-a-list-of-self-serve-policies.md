...
1. Call the [**IAggregatePartner.With(IRequestContext)**](/dotnet/api/microsoft.store.partnercenter.iaggregatepartner.with?view=partnercenter-dotnet-latest&preserve-view=true) method with the entity identifier to retrieve an interface to operations on the policies.
