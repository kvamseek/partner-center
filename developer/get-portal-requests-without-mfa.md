...
This article explains how to obtain a list of the most recent requests from users who access Partner Center without completing multi-factor authentication (MFA).
