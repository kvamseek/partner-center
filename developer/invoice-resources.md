...
| collectionOfSummary | array of [TaxReceipt](/dotnet/api/microsoft.store.partnercenter.models.invoices.taxreceipt?view=partnercenter-dotnet-latest&preserve-view=true) objects | Gets or sets the tax receipt download link.             |
