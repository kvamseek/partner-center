...
| Substatus          | [ReferralSubstatus](referral-resources.md#referralsubstatus)      | An [Enum](/dotnet/api/system.enum) with values that indicate the referral sub status. |
...
An [Enum](/dotnet/api/system.enum) with values that indicate the referral status.
...
| Accepted        | Represents an active referral that has been accepted.                                                    |
...
An [Enum](/dotnet/api/system.enum) with values that indicate the referral type.
...
| Team     | [Member](referral-resources.md#member)                           | The contacts for the customer's organization.            |
| IDs      | [CustomerProfileType](referral-resources.md#customerprofiletype) | An [Array](/dotnet/api/system.array) of values that indicate External IDs for the customer.                        |
...
| Property    | Type   | Description                  |
|-------------|--------|------------------------------|
| Locale   | string | The locale of the email notification. [AllCultures](/dotnet/api/system.globalization.culturetypes?view=netframework-4.7.2#System_Globalization_CultureTypes_AllCultures&preserve-view=true), [NeutralCultures](/dotnet/api/system.globalization.culturetypes?view=netframework-4.7.2#System_Globalization_CultureTypes_NeutralCultures&preserve-view=true), and [SpecificCultures](/dotnet/api/system.globalization.culturetypes?view=netframework-4.7.2#System_Globalization_CultureTypes_SpecificCultures&preserve-view=true) are supported  |
...
| Currency              | string                                                    | The [ISO 4217 currency symbol](/dotnet/api/system.globalization.regioninfo.isocurrencysymbol?view=netframework-4.7.2&preserve-view=true)                                   |
...
An [Enum](/dotnet/api/system.enum) with values that indicate the solution type.
