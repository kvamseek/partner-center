...
description: Suspends a Subscription resource that matches the customer and subscription ID due to fraud or non-payment. In Partner Center, this operation can be performed by first selecting a customer.
ms.date: 06/13/2022
...
In Partner Center, this operation can be performed by first [selecting a customer](get-a-customer-by-name.md). Then, select the subscription in question that you wish to rename. To finish, choose the **Suspended** button, then select **Submit.**
