...
1. On the Marketplace offers page, select **+ New offer** > **Azure Application**.
    ...
    :::image type="content" source="./media/create-new-azure-app-offer/new-offer-azure-app-workspaces.png" alt-text="Illustrates the New offer button on the Marketplace offers page." lightbox="./media/create-new-azure-app-offer/new-offer-azure-app-workspaces.png":::
