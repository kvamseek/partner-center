...
:::image type="content" source="media/create-new-azure-app-offer/azure-app-publish-status.png" alt-text="Illustrates the Offer overview page for an offer in Partner Center. The Go live button and preview links are shown." lightbox="media/create-new-azure-app-offer/azure-app-publish-status.png":::
