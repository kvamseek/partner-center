...
1. On the Marketplace offers page, select **+ New offer** > **Azure Container**.
    ...
    :::image type="content" source="./media/azure-container/new-offer-azure-container-workspaces.png" alt-text="The left pane menu options and the 'New offer' button." lightbox="./media/azure-container/new-offer-azure-container-workspaces.png":::
