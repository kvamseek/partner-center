...
You can create up to 100 plans for each offer: up to 45 of these can be private. Learn more about private plans in [Private offers in the Microsoft commercial marketplace](private-plans.md).
...
:::image type="content" source="./media/azure-container/new-plan-information.png" alt-text="Screenshot illustrating the demo offer plan overview screen where users can create a new plan.":::
