...
:::image type="content" source="media/vm/call-api-in-powershell.png" alt-text="Screen example for calling the API in PowerShell." lightbox="media/vm/call-api-in-powershell.png":::
...
:::image type="content" source="media/vm/call-api-in-powershell-details.png" alt-text="Screen example for calling the API in PowerShell with details of test results." lightbox="media/vm/call-api-in-powershell-details.png":::
...
:::image type="content" source="media/vm/test-results-json-viewer-1.png" alt-text="More test results in an online JSON viewer.":::
...
:::image type="content" source="media/vm/test-results-json-viewer-2.png" alt-text="Test results in an online JSON viewer.":::
