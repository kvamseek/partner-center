...
:::image type="content" source="./media/office-store-new/additional-purchases.png" alt-text="Additional purchases step with unchecked box indicating a service must be purchased or in-app purchases are offered":::
...
:::image type="content" source="./media/add-in-submission-guide/step-5-b-validation.jpg" alt-text="Support information fillable form fields":::
...
:::image type="content" source="./media/office-store-new/step-7-marketplace-listing.png" alt-text="Marketplace listing form":::
