...
:::image type="content" source="media/marketplace-publishers-guide/csp-reseller-audience.png" alt-text="CSP Reseller audience":::
...
:::image type="content" source="media/marketplace-publishers-guide/csp-reseller-option-one.png" alt-text="Any partner in the CSP program":::
...
:::image type="content" source="media/marketplace-publishers-guide/csp-reseller-option-two.png" alt-text="Specific partners in the CSP program I select":::
...
:::image type="content" source="media/marketplace-publishers-guide/csp-pop-up-module.png" alt-text="Select CSP menu":::

You can apply search filters, such as **Country**, **Competency**, or **Skill**.

:::image type="content" source="media/marketplace-publishers-guide/csp-add-resellers.png" alt-text="Country/region, competency, and skill filters for partner search":::

Once you've chosen the list of partners, select **Add**.

:::image type="content" source="media/marketplace-publishers-guide/csp-add-resellers-details.png" alt-text="Example list of authorized partners in the CSP program":::

A table showing the list of partners you selected appears on the CSP Reseller audience page.

:::image type="content" source="media/marketplace-publishers-guide/csp-option-two-add-reseller.png" alt-text="Table with list of partners on CSP Reseller audience page":::
...
:::image type="content" source="media/marketplace-publishers-guide/csp-reseller-option-three.png" alt-text="No partners in the CSP program":::
...
:::image type="content" source="media/marketplace-publishers-guide/pc-csp-channel.png" alt-text="Partner Center CSP collateral information":::
