...
Ensure you have an active Microsoft AI Cloud Partner Program membership and are enrolled in the commercial marketplace in Partner Center.

- Join the Microsoft AI Cloud Partner Program [at no cost](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership). As a partner, you’ll have access to exclusive resources, programs, tools, and connections to grow your business.
...
For your solution to be discoverable to Microsoft sellers and partners, it must meet the [co-sell ready requirements](../co-sell-overview.md?context=%2fazure%2fmarketplace%2fcontext%2fcontext). For a Microsoft seller to be a Co-sell incentive, your solution must meet the [incentive-eligible requirements](../co-sell-overview.md?context=%2fazure%2fmarketplace%2fcontext%2fcontext). Complete these requirements on the co-sell tab in Partner Center (see [this image](#action-2-merge) later in this article).
...
1. Create a draft offer in commercial marketplace
   ...
   1. On the commercial marketplace Overview page, select **+ New Offer**, and then select the offer type you want.
        ...
        :::image type="content" source="media/co-sell-migrate/new-offer-workspaces.png" alt-text="Screenshot of the New Offer button on the Marketplace offers page." lightbox="media/co-sell-migrate/new-offer-workspaces.png":::
   ...
   2. Complete the required information in each tab.
      ...
      - Optionally, complete the **Resell through CSPs** page (in the left-nav menu below) to resell through the Cloud Solution Provider (CSP) program.
        ...
        :::image type="content" source="media/co-sell-migrate/offer-setup-nav-workspaces.png" alt-text="Displays the Offer Setup page with overview options highlighted." lightbox="media/co-sell-migrate/offer-setup-nav-workspaces.png":::
   ...
   3. Select **Save Draft**.
    ...
    After the merge is complete you can return to the Co-sell with Microsoft tab and make updates if needed. For more information, see [Configure co-sell for a commercial marketplace offer](../co-sell-configure.md?context=%2fazure%2fmarketplace%2fcontext%2fcontext).
1. When complete, select **Review and publish**.

    :::image type="content" source="media/co-sell-migrate/co-sell-with-ms-workspaces.png" alt-text="Co-Sell with Microsoft page is displayed with options highlighted." lightbox="media/co-sell-migrate/co-sell-with-ms-workspaces.png":::
...
1. Identify the existing offer.
   ...
   1. Select **Continue**.
        :::image type="content" source="media/co-sell-migrate/action-1-merge.png" alt-text="The Action 1 tab of the merge process." lightbox="media/co-sell-migrate/action-1-merge.png":::
1. Request the merge.
    ...
    <a id="action-2-merge"></a>
        :::image type="content" source="media/co-sell-migrate/action-2-merge.png" alt-text="The Action 2 tab of the merge process." lightbox="media/co-sell-migrate/action-2-merge.png":::
...
- [Configure co-sell for a commercial marketplace offer](../co-sell-configure.md?context=%2fazure%2fmarketplace%2fcontext%2fcontext)
