...
1. On the Marketplace offers page, select **+ New offer** > **Consulting service**.
    ...
    :::image type="content" source="./media/new-offer-consulting-service-workspaces.png" alt-text="Illustrates the New offer list on the Marketplace offers page." lightbox="./media/new-offer-consulting-service-workspaces.png":::
