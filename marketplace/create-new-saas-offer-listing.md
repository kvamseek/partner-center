...
Under **Logos**, upload a **Large** logo in PNG format between 216 x 216 and 350 x 350 pixels with equal dimensions (example 300 x 300, 250 x 250 etc.). Partner Center will automatically create **Small** (48 x 48) and **Medium** (90 x 90) logos, which you can replace later if you want.
