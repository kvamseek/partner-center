---
title: Create a Dynamics 365 apps on Dataverse and Power Apps offer on Microsoft AppSource
...
1. On the Marketplace offers page, select **+ New offer** > **Dynamics 365 apps on Dataverse and Power Apps**.
    ...
    [ :::image type="content" source="./media/dynamics-365/new-offer-dynamics-365-customer-engagement-workspaces.png#lightbox" alt-text="Shows the 'New offer' button with the Customer Engagement & Power Apps offer type selected.](./media/dynamics-365/new-offer-dynamics-365-customer-engagement-workspaces.png) ":::
