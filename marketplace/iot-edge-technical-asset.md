...
- To learn more about IoT Edge modules, see [Understand Azure IoT Edge modules](/azure/iot-edge/iot-edge-modules).
- To get started with your IoT Edge module development, see [Develop your own IoT Edge modules](/azure/iot-edge/module-development).
...
Your module must support all Tier 1 platforms supported by IoT Edge (as recorded in [Azure IoT Edge support](/azure/iot-edge/support)). We recommend this option because it provides a better customer experience. Modules that meet this criteria will be showcased. A module using this platform option must:
...
Your module must support a subset (at least one) of Tier 1 platforms supported by IoT Edge (as recorded in [Azure IoT Edge support](/azure/iot-edge/support)). A module using this platform option must:
