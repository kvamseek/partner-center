...
:::image type="content" source="./media/isv-app-license/power-bi-transact-appsource.png" alt-text="Screenshot of listing options on an offer listing page in Microsoft AppSource." lightbox="./media/isv-app-license/power-bi-transact-appsource.png":::
