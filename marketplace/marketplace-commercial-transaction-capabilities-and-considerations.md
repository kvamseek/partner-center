...
:::image type="content" source="media/marketplace-commercial-transaction-capabilities-and-considerations/plans-offer-type-and-pricing-plan-flowchart-updated-12-21-2022.png" alt-text="Screenshot of the commercial marketplace plans offer types and pricing plan flowchat.":::
...
Any software licensing fees collected by Microsoft as an agent are subject to a 3% store service fee unless otherwise specified and are deducted at the [time of publisher payout](../payout-policy-details.md).
