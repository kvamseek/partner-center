...
:::image type="content" source="media/monetize-addins/saas-update-api-v2-calls-from-saas-service-a.png" alt-text="API calls when the update is initiated from the SaaS service":::
