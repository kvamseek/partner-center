...
:::image type="content" source="media/anomaly-1.png" alt-text="Illustrates anomalies detected outside a predictable trend.":::

Anomalies detected outside a recurring cyclic trend:

:::image type="content" source="media/anomaly-2.png" alt-text="Illustrates anomalies detected outside a recurring cyclic trend.":::

Anomalies detected in an upward trend:

:::image type="content" source="media/anomaly-3.png" alt-text="Illustrates anomalies detected in an upward trend.":::
