...
> [!NOTE]
> For some primary products, you must have a Gold or Silver Microsoft competency in your solution area. For more information, see [Microsoft AI Cloud Partner Program Competencies](https://partner.microsoft.com/membership/competencies).
...
:::image type="content" source="./media/example-consulting-service.png" alt-text="Illustrates how a consulting service offer appears in the online stores":::
