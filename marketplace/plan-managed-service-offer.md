...
Managed Services are Azure Marketplace offers that enable cross-tenant and multi-tenant management with Azure Lighthouse. To learn more, see [What is Azure Lighthouse?](/azure/lighthouse/overview) When a customer purchases a Managed Service offer, they’re able to delegate one or more subscription or resource group. You can then work on those resources by using [Azure Lighthouse](/azure/lighthouse/overview).

## Eligibility requirements

To publish a Managed Service offer, you must have a Solutions Partner designation for Infrastructure (Azure).

OR,

Retained benefits in the following competency based on competencies held as of September 30, 2022: Silver or Gold competency in Cloud Platform.

This demonstrates your expertise to customers. For more information, see [Solution Partner designations](https://partner.microsoft.com/membership/competencies). Offers must meet all applicable [commercial marketplace certification policies](/legal/marketplace/certification-policies) to be published on Azure Marketplace.
