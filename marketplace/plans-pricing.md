...
:::image type="content" source="./media/commercial-marketplace-plans/plan-listing-tab.png" alt-text="Illustrates the plan listing page in Partner Center. The Plan name, Plan summary, and Plan description fields are highlighted.":::
...
- **Plan summary**: (Callout 2 in the image above.) This summary appears in Azure Marketplace search results and can contain up to 100 characters. This field doesn't apply to SaaS offers.
   > [!NOTE]
...
:::image type="content" source="./media/commercial-marketplace-plans/offer-listing-page.png" alt-text="Illustrates an Offer listing page in Partner Center. Three plans are shown.":::
...
> [!TIP]
> Plans are displayed on the **Plan overview** page in the order they are created. Filtering this list is not supported, but you can use Ctrl+F to quickly locate a plan from your browser. 

The following screenshot shows two draft offers.

:::image type="content" source="./media/commercial-marketplace-plans/plan-overview-tab.png" alt-text="Illustrates the Plan overview page in Partner Center. Two plans are shown.":::
...
- **Markets**: Every plan must be available in at least one market.  You have the option to select only "Tax Remitted" countries/regions, in which Microsoft remits sales and use tax on your behalf.
