...
1. On the Marketplace offers page, select **+ New offer** > **Power BI app**.
    ...
    :::image type="content" source="./media/power-bi/new-offer-power-bi-app-workspaces.png" alt-text="Illustrates the Power BI app offer type available from the New offer button." lightbox="./media/power-bi/new-offer-power-bi-app-workspaces.png":::
