...
1. On the Marketplace offers page, select **+ New offer** > **Power BI visual**.
    ...
    :::image type="content" source="media/power-bi-visual/new-offer-power-bi-visual-workspaces.png" alt-text="Shows the left pane menu options and the 'New offer' button." lightbox="media/power-bi-visual/new-offer-power-bi-visual-workspaces.png":::
