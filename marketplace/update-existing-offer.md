...
> [!TIP]
> Watch this [6-min video](https://microsoft.github.io/Mastering-the-Marketplace/partner-center/general/#migrating-listings-to-saas-offers) to learn how to convert your existing listing into a fully transactable SaaS Offer.
...
- To see only values that haven't been updated, select the **Unchanged fields** filter. The field values shown for the published and draft version will be the same.
  ...
  :::image type="content" source="media/compare-changes-marketplace.png" alt-text="Filters for comparing updates to your published or preview offer":::
...
> [!NOTE]
> For SaaS offers, customers who previously acquired the offer or plan can renew their subscription using the [edit recurring billing.](/marketplace/saas-subscription-lifecycle-management) They can also change to a different live plan using the [change plan.](/marketplace/saas-subscription-lifecycle-management)  
