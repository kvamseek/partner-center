...
:::image type="content" source="media/view-usage-report/multiple-apps.png" alt-text="Screenshot of the Usage dashboard showing the multiple apps list." lightbox="media/view-usage-report/multiple-apps.png":::
